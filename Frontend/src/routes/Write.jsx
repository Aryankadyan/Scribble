...
<button disabled = {mutation.isPending || (0 > progress && progress < 100)}  className='bg-orange-500 text-white font-medium rounded-xl mt-4 p-2 w-36 disabled:bg-blue-400 disabled:cursor-not-allowed'>
