...
const PostMenuAction = ({post}) => {
  ...
  return (
    <div className="">
        ...
        {isPending ? ("Loading..."): error ? ("Saved post fetching failed!" ):( <div className="flex items-center gap-3 py-3 text-sm cursor-pointer" onClick={handleSave}> 
            <svg
        ...
        { 
            isAdmin && <div className='flex items-center gap-3 py-3 text-sm cursor-pointer' onClick={handleFeature}>
                 <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 48 48"
            width='20px'
