...
const SideMenu = () => {
  ...
  return (
    <div className="px-4 h-max sticky top-8">
      ...
      <Search/>
      <h1 className="mt-8 mb-4 text-sm font-bold text-teal-500">Filter</h1>
      <div className='flex flex-col gap-2 text-sm'>
        <label htmlFor='' className='flex items-center gap-3 cursor-pointer'>
            ...
            value='newest'
            className='appearance-none w-4 h-4 border-[1.5px] border-blue-800 cursor-pointer rounded-sm bg-white checked:bg-black'
            />
            Newest
        </label>
        <label htmlFor='' className='flex items-center gap-3 cursor-pointer'>
